...
public class GeneralItemVisibilityClient extends GenericClient{
	...
	public GeneralItemVisibilityList getGeneralItemVisibilities(String token, Long runId, Long from) {
		return (GeneralItemVisibilityList) executeGet(getUrlPrefix()+"/runId/"+runId + "?from="+from, token, GeneralItemVisibilityList.class);
	}
}
