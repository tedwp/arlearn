...
public class ChannelAPI {
    ...
    private String BASE_URL = "http://127.0.2.2:8888"; //Defaults to LocalHost
...
//        }
    ...
    private String createChannel(String key) throws IOException, ClientProtocolException{
		...
		try{
			...
			return "channel--qp636z-stefaan:run1";
		}
    	return token;
    }
    ...
    public void open() throws IOException, ChannelException {
    	...
    	if(this.BASE_URL.contains("2.2")){ //Local Development Mode
