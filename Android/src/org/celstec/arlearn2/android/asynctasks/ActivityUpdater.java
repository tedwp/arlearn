...
import org.celstec.arlearn2.android.genItemActivities.*;
	...
	public static void updateActivities(Context ctx, String... activities) {
		...
		for (int i = 0; i < activities.length; i++) {
			...
			if (activities[i].equals(NarratorItemActivity.class.getCanonicalName())) {
                updateIntent.putExtra(SingleChoiceActivity.class.getCanonicalName(), true);
                updateIntent.putExtra(MultipleChoiceActivity.class.getCanonicalName(), true);
