 ...
 * ****************************************************************************
 */
public class ActionModel extends DataSourceModel {
    ...
    public static final String ACCOUNT_FIELD = "userEmail";

    public ActionModel(DataSourceAdapter dataSourceAdapter) {
        super(dataSourceAdapter);
    }

    @Override
    protected void initFields() {
        addField(STRING_DATA_TYPE, ACTION_FIELD, false, true);
    ...
    protected String getNotificationType() {
        return "org.celstec.arlearn2.beans.run.Action";
    }
}
