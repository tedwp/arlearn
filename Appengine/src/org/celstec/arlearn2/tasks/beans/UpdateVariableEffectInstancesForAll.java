 ...
 * ****************************************************************************
 */
public class UpdateVariableEffectInstancesForAll extends GenericBean{

    private Long runId;
    private Long gameId;
    private Integer updateType;

    public UpdateVariableEffectInstancesForAll() {

    }

    public UpdateVariableEffectInstancesForAll(String token, Account accountAuth, Long runId, Long gameId, Integer updateType) {
