...
package net.wespot.pim.utils.images;
...
public class Images {
    ...
    private static final String URL_PATH = "/arlearn2/incomming_runs/19806001/";
    private static Images a;

//    public ArrayList<String> imageUrls = new ArrayList<String>();
public static List<ResponseLocalObject> responseLocalObjectList = null;
//    public final static ArrayList<String> imageThumbUrls = new ArrayList<String>();
//    public final static Array[] imageUrls = new Array();
//    public final static String[] imageThumbUrls = new String[0];
    ...
    public static Images getInstance(Context ctx) {
        ...
        if (a==null){
            ...
            responseLocalObjectList = DaoConfiguration.getInstance().getResponseLocalObjectDao().loadAll();
     ...
     */
//    public final static String[] imageUrls = new String[0];
//    {
