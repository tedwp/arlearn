...
//            return API.responseLocalObjectList.size() + mNumColumns;
            return INQ.inquiry.getCurrentInquiry().getRunLocalObject().getResponses().size() + mNumColumns;
        }

        @Override
        public Object getItem(int position) {
            return position < mNumColumns ? null : INQ.inquiry.getCurrentInquiry().getRunLocalObject().getResponses().get(position - mNumColumns);
//            return position < mNumColumns ? null : Images.getInstance().imageThumbUrls.get(position - mNumColumns);
        }
...
//                        ViewGroup.LayoutParams.MATCH_PARENT, mActionBarHeight));
            ...
            Log.e(TAG, INQ.inquiry.getCurrentInquiry().getRunLocalObject().getResponses().get(position - mNumColumns).getUri()+"");
            mImageFetcher.loadImage(INQ.inquiry.getCurrentInquiry().getRunLocalObject().getResponses().get(position - mNumColumns).getUri(), imageView);
//            mImageFetcher.loadImage(Images.getInstance().imageThumbUrls.get(position - mNumColumns), imageView);
            return imageView;
        }
