...
//    UIColor *color = [UIColor colorWithRed:0.667 green:0.15 blue:0.152 alpha:1.0];
     UIColor *   color = [UIColor colorWithRed:(99.0f/256.0f) green:(187.0f/256.0f) blue:(255.0f/256.0f)alpha:0.2];
    [colors addObject:(id)[color CGColor]];
//    color = [UIColor colorWithRed:0.841 green:0.566 blue:0.566 alpha:1.0];
    color = [UIColor colorWithRed:(99.0f/256.0f) green:(187.0f/256.0f) blue:(255.0f/256.0f)alpha:0.3];
    [colors addObject:(id)[color CGColor]];
//    color = [UIColor colorWithRed:0.75 green:0.341 blue:0.345 alpha:1.0];
    color = [UIColor colorWithRed:(99.0f/256.0f) green:(187.0f/256.0f) blue:(255.0f/256.0f)alpha:1.0];
    [colors addObject:(id)[color CGColor]];
