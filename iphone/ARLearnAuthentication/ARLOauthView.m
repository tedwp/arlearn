...
- (id)init {
    ...
    if (self) {
        ...
        [self.authLabel setTextAlignment:NSTextAlignmentCenter];
        self.authLabel.text = NSLocalizedString(@"AuthExistingAccount", nil);
        self.authLabel.backgroundColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.0];
